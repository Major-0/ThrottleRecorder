...
#define steeringPin STEERING_CH1_PIN
#define throttlePin THROTTLE_BR_CH2_PIN
...
int steeringReading = analogRead(steeringPin);
  ...
  float throttleVoltage = (throttleReading * 5.0) / 1024.0;
  float steeringVoltage = (steeringReading * 5.0) / 1024.0;
  
  logfile.print("Data We Read from Throttle Pin: ");
  logfile.print(throttleReading);
  logfile.print(", ");
  logfile.print("Data We Read from Steering Pin: ");
  logfile.print(steeringReading);
  logfile.print("Calculated Throttle Voltage: ");
  logfile.println(throttleVoltage);
  logfile.print("Calculated Steering Voltage: ");
  logfile.println(steeringVoltage);
#if ECHO_TO_SERIAL 
  Serial.print("Data We Read from Throttle Pin: ");
  Serial.print(throttleReading);
  Serial.print(", ");
  Serial.print("Data We Read from Steering Pin: ");
  Serial.print(steeringReading);
  Serial.print("Calculated Throttle Voltage: ");
  Serial.println(throttleVoltage);
  Serial.print("Calculated Steering Voltage: ");
  Serial.println(steeringVoltage);
